...
class CustomDiffusionInferer(Inferer):
    """
    CustomDiffusionInferer takes a trained diffusion model and a scheduler and can be used to perform a signal forward pass
    ...
    def sample(
        ...
        verbose: bool = True,
        seg: torch.Tensor | None = None,
        replace_from_t: int = -1,
        replace_tensor: torch.Tensor | None = None
        ...
        for t in progress_bar:
            ...
            # replace previously computed image with input image
            # print(f"t is {t}")
            if replace_from_t == t and replace_tensor is not None:
                image = replace_tensor
                print(f"image replace at {t}.")
...
class LatentDiffusionInferer(CustomDiffusionInferer):
    """
...
class ControlNetDiffusionInferer(CustomDiffusionInferer):
    """
